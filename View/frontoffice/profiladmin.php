...
<div class="box1 box">
  <div class="content">
    <div class="image">
      <img src="../../asset//frontoffice/images/syrine.jpg" alt="Profile Image" width="500" >
    </div>
 
    <div class="text">
      <p class="name">Syrine toumi</p>
      <p class="job_title">ADMIN</p>
      <p class="job_discription">id=5 <br> Numero telephone: 98522550<br>Cin : 15477785 <br>Email: syrine.toumi@esprit.tn <br>.</p>
    </div>
    <div class="icons">
      <button>
    ...
    <div class="button">
      ...
      <div>
        <button class="connect" type="button"><a href="admin.php">Retour</a></button>
      </div>
    </div>
  </div>
</div>
