...
<div class="box1 box">
  <div class="content">
    <div class="image">
      <img src="../../asset//frontoffice/images/coach.jpg" alt="Profile Image" width="500" >
    </div>
 
    <div class="text">
      <p class="name">flen ben foulen</p>
      <p class="job_title">COACH</p>
      <p class="job_discription">id=10 <br> Numero telephone: 50821394<br>Cin : 01236547 <br>Email: flen.benfoulen@esprit.tn <br>.</p>
    </div>
    <div class="icons">
      <button>
    ...
    <div class="button">
      ...
      <div>
        <button class="connect" type="button"><a href="coach.php">Retour</a></button>
      </div>
    </div>
  </div>
</div>
