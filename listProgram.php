...
<center>
    ...
    <h2>
        <a href="addProgram.php" id="aa">Ajouter programme</a>
    </h2>
</center>
<table border="1" align="center" width="70%">
    ...
    ?>
        ...
        <tr>
            ...
            <td><?= $programme['nom']; ?></td>
            <td><?= $programme['prenom']; ?></td>
            <td><?= $programme['maladie']; ?></td>
            <td><?= $programme['exercice']; ?></td>
            ...
            <td align="center">
                ...
                <button style="width: 115.2px;color:green" class="bouton" id="up1"type="submit" name="update" value="Update">
                    ...
                    <input type="hidden" value=<?PHP echo $programme['idprogramme']; ?> name="idprogramme">Mise a jour
                </button>
                </form>
            </td>
            <td>
    <form method="GET" action="deleteProgram.php">
        <input type="hidden" value="<?= $programme['idprogramme']; ?>" name="id">
