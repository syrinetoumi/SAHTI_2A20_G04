...
if (
    ...
    if (
        ...
        $rdvAnalyseC->addRDV_analyse_imagerie($analyse);
...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
    ...
    <button type="button" class="appointment-btn" id="mis" style="height: 36px; width: 76px;" onclick="window.location.href='listConsultation.php'">Show List</button>
                         ...
                         <form action="addAnalyse.php" method="POST">
                         <table>
                <tr>
                    <td><label for="id">ID:</label></td>
                    <td>
                        <input id="id" name="id" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7"  />
                ...
                <tr>
                    ...
                    <td>
                    <input id="centre_analyse" name="centre_analyse" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7"/>
                ...
                <tr>
                    ...
                    <td>
                    <input id="imagerie" name="imagerie" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7"/>
                ...
                <tr>
                    ...
                    <td>
                    <input id="nom_radiologue" name="nom_radiologue" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7" />
