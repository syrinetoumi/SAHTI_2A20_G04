          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                         <li><a href="../Views/frontoffice/index.html">Accueil</a></li>
...
<br><br<br<br><br><br<br<br><br><br<br<br><br><br<br<br>
<!-- ... existing code ... -->
<h2 id="mod">Listes des rendez-vous</h2>
<center>
...
<section id="cordonnee">
     <center>
          <table width="90%" border="1" style="border-collapse: collapse; border-color: black; background-color:white;">
               <caption align ="center" style="background-color: black; color:#b1fa07;">RVD Consultation Information</caption>
            <tr>
                <th >ID</th>
        ...
        <tr>
            ...
            <td align="center">
                <form method="POST" action="updateanalyse.php">
                    <input type="submit" name="update" value="Update" style="height: 36px;width: 76px;">
                    <input type="hidden" value="<?= $rdv['id']; ?>" name="id">
                    <!-- Add similar hidden fields for other properties of RDV_Consultation -->
                </form>
            </td>
            <td align="center">
                <form method="POST" action="deleteAnalyse.php">
